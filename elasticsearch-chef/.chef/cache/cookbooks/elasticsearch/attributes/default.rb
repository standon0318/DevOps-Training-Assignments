...
default['elasticsearch']['directory']['conf'] = "#{node['elasticsearch']['home']}/config"
...
default['ec2plugin']['download']['url'] = 'https://s3.amazonaws.com/kenobi-packages/discovery-ec2-6.3.1.zip'
